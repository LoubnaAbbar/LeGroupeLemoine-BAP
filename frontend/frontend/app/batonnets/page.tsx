...
import styles from "./batonnets.module.css";
...
const produits = [
  { label: "Bâtonnet maxi confort",   src: "/images/image1.jpg" },
  { label: "Bâtonnet sécurité bébé",  src: "/images/image2.jpg" },
  { label: "Bâtonnet cosmétique",     src: "/images/image3.jpg" },
  { label: "Bâtonnet ouaté",          src: "/images/image4.jpg" },
];

const sectionsData = [
  {
    titre: "Les embouts",
    texte: "Les bâtonnets standards, bâtonnets premium, bâtonnets bébé ou les bâtonnets cosmétiques se distinguent par la forme et la taille de leur embout. Selon l'utilisation, ces embouts « personnalisés » procurent plus de confort, plus de sécurité ou plus de précision. Le Groupe propose également des embouts coton issus de l'agriculture biologique et du commerce équitable.",
    src: "/images/image5.jpg",
    reverse: false,
  },
  {
    titre: "Les sticks",
    texte: "Les gammes de bâtonnets peuvent être développées en sticks standard ou FSC, blancs ou colorés.",
    src: "/images/image6.png",
    reverse: true,
  },
  {
    titre: "Les packagings",
    texte: "En formats familiaux ou nomades, en plastique ou en carton, neutres ou personnalisables à l'envi, nos packagings s'adaptent à tous les besoins !",
    ...
    <div className={styles.container}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroImg}>
          <Image
            src="/images/batonnets.jpg"
            alt="Bâtonnets de cotonnade"
            fill
          ...
          <div className={styles.heroText}>
            <h1>Bâtonnets</h1>
            <p>Nos modèles de bâtonnets ont des formes adaptées à toutes les utilisations de la famille : hygiène auriculaire des grands et des petits, retouches maquillage…</p>
          </div>
        </div>
      </section>
{/* ── BANDEAU PRODUIT UNIQUE ── */}
<section className={styles.prodSection}>
  <div className={styles.inner}>
    <div className={styles.prodBanner}>
      <div className={styles.prodBannerImg}>
        <Image
          src="/images/blabla.png"
          alt="Gamme bâtonnets"
          fill
          style={{ objectFit: "cover", objectPosition: "center" }}
        />
        {/* Overlay dégradé */}
        <div className={styles.prodBannerOverlay} />
        {/* Texte superposé */}
        <div className={styles.prodBannerText}>
          <h2>Notre gamme complète</h2>
          <div className={styles.prodBannerTags}>
            {[
              "Bâtonnet maxi confort",
              "Bâtonnet sécurité bébé",
              "Bâtonnet cosmétique",
              "Bâtonnet ouaté",
            ].map((label) => (
              <span key={label} className={styles.prodBannerTag}>
                {label}
              </span>
            ))}
          </div>
      ...
      <section className={styles.cert}>
        <div className={styles.inner}>
          ...
          <div className={styles.certGrid}>
            {["Blanc Angles FSC","Autres Angles FSC","Blanc Angles PEFC","Lavande Angles CE"].map((c,i) => (
